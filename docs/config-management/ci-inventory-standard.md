...
| RMT-PIPE-001 | Container Build and Publish Workflow | Deployment pipeline component | dev/prod | DevOps Owner | high | .github/workflows/publish-container.yml | Image build, publish, and dev restart automation | RMT-APP-001, RMT-EXT-002, RMT-INFRA-002 | 2026-07-08 | workflow file review |
