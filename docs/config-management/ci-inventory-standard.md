...
| CI ID | CI Name | CI Class | Env | Owner | Criticality | Source of Truth | Related Service | Dependencies | Last Verified | Verification Method |
|---|---|---|---|---|---|---|---|---|---|---|
| RMT-APP-001 | RMT Core PHP Application | Application component | local/dev/prod | Application Team | critical | app/ | Request intake, triage, and request lifecycle | RMT-DB-001, RMT-INFRA-001, RMT-EXT-001, RMT-EXT-003 | 2026-08-25 | implementation and deployment documentation review |
...
| RMT-EXT-003 | Azure Blob Attachment Storage | External integration | dev/prod | Cloud Operations | critical | app/BlobStorage.php, docs/AZURE-APP-SERVICE-BLOB-STORAGE.md | Persistent request attachment storage | RMT-APP-001, RMT-INFRA-002 | 2026-08-25 | implementation and deployment documentation review |
