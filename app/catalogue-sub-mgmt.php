			...
			<table class="wb-tables wb-tables-filter table table-striped table-hover" data-wb-tables='{ "ordering" : true }'>
				...
				?>
					<tr>
						...
						<td>
							<a class="wb-lbx btn btn-primary" href="includes/edit-subservice.php?id=<?php echo $row['id'];?>&sid=<?php echo $serviceid ?>&cid=<?php echo $catalogueid ?>"><?= htmlspecialchars($lang['edit_button']) ?><span class="wb-inv"> <?php echo htmlspecialchars($row[$nameColumn]) ?></span> <?= htmlspecialchars($lang['catalogue_sub_mgmt_subservice_label']) ?></a> <a class="wb-lbx btn btn-primary" href="includes/delete-subservice.php?id=<?php echo $row['id'];?>&sid=<?php echo $serviceid ?>&cid=<?php echo $catalogueid ?>"><?= htmlspecialchars($lang['delete_button']) ?><span class="wb-inv"> <?php echo htmlspecialchars($row[$nameColumn]) ?></span> <?= htmlspecialchars($lang['catalogue_sub_mgmt_subservice_label']) ?></a>
						</td>
					</tr>
				<?php } ?>
				</tbody>
