			...
			<table class="wb-tables wb-tables-filter table table-striped table-hover" data-wb-tables='{ "ordering" : true }'>
				...
				?>
					<tr>
						...
						<?php if ($_SESSION['atype'] == 1) { ?>
						<td>
							<a class="wb-lbx btn btn-primary mrgn-rght-sm" href="includes/edit-source.php?id=<?php echo $row['id'];?>"><?= htmlspecialchars($langFile['edit_button']) ?><span class="wb-inv"> <?php echo htmlspecialchars($row[$nameColumn]) ?></span> <?= htmlspecialchars($langFile['sources_source_label']) ?></a><?php if ($_SESSION['atype']=='1') {?> <a class="wb-lbx btn btn-primary" href="includes/delete-source.php?id=<?php echo $row['id'];?>"><?= htmlspecialchars($langFile['delete_button']) ?><span class="wb-inv"> <?php echo htmlspecialchars($row[$nameColumn]) ?></span> <?= htmlspecialchars($langFile['sources_source_label']) ?></a><?php } ?>
						</td>
						<?php } ?>
					</tr>
				<?php } ?>
