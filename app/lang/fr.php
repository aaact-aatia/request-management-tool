...
return [
    ...
    'admin_csv_import_tip_order' => 'L\'ordre des colonnes et les colonnes supplémentaires n\'ont pas d\'importance',
    ...
    // Intake flow runtime (intake-flow.php)
    'intake_step_heading'           => 'Avant de soumettre votre demande',
    'intake_continue'               => 'Continuer',
    'intake_select_catalogue_continue' => 'Continuer vers la sélection du service',
    'intake_select_service_continue'   => 'Continuer avec ce service',
    'intake_start_questionnaire'       => "Commencer le questionnaire d'accueil",
    'intake_service_label'             => 'Service',
    'intake_cascade_invalid'           => 'Choisissez un type de service et un service valides.',
    'intake_back'                   => 'Retour',
    'intake_start_over'             => 'Recommencer',
    'intake_continue_to_form'       => 'Continuer vers le formulaire de demande',
    'intake_error_invalid'          => "Une erreur s'est produite. Veuillez recommencer.",
    'intake_error_draft'            => "Ce parcours d'accueil n'est pas encore publié.",
    'intake_error_expired'          => 'Votre session a expiré. Veuillez recommencer.',
    'intake_error_csrf'             => "La requête n'était pas valide. Veuillez recommencer.",
    'intake_error_flow_invalid'     => "Ce service n'est pas disponible pour le moment. Veuillez réessayer plus tard ou contacter le Bureau de l'accessibilité de la TI.",
    'intake_error_flow_required'    => 'Ce service nécessite que vous répondiez à un questionnaire d\'accueil. Veuillez recommencer.',
    'intake_specify'                => 'Précisez',
    'intake_your_answer'            => 'Votre réponse :',
    'intake_retry'                  => 'Réessayer',
    'intake_error_summary_heading'  => 'Des erreurs se trouvent dans ce formulaire',
    'intake_error_option_required'  => 'Veuillez sélectionner une option.',
    'intake_error_freeform_required'=> 'Veuillez saisir du texte dans ce champ.',
    'intake_error_network'          => 'Erreur réseau. Veuillez réessayer.',
    'intake_error_missing_node'     => "Cette étape n'a pas pu être complétée. Veuillez recommencer.",
    'intake_error_stale'            => "Cette page n'est plus à jour. Veuillez actualiser la page et réessayer.",
    'intake_restart_complete'       => "Le questionnaire d'accueil a été réinitialisé.",
    'intake_resources_heading'      => 'Ressources',
    'intake_guidance_return_prompt' => 'Pour continuer, veuillez revenir à ce formulaire après avoir suivi les consignes ci-dessus.',
    'intake_destination_heading'    => 'Votre parcours est complet',
    'intake_destination_subheading' => 'Cliquez sur le bouton ci-dessous pour ouvrir le formulaire de demande.',
    'intake_step_of'                => 'de',
];
