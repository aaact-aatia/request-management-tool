...
<div class="pull-right"><a class="wb-lbx lbx-modal btn btn-primary mrgn-bttm-md" href="includes/add-status.php"><?= htmlspecialchars($langFile['status_add_button']) ?></a></div>
