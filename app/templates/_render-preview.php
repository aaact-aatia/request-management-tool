...
$messageScenarios = [
    ...
    'reassigned_team' => [
        'label_en' => 'Assigned notification to team',
        'label_fr' => 'Notification d assignation à l équipe',
        'event' => 'reassigned',
        'recipientType' => 'internal',
        'description_en' => 'Internal team message when a request is assigned.',
        'description_fr' => 'Message interne lorsque la demande est assignée.',
        'status_label_en' => 'In progress',
        'status_label_fr' => 'En cours',
    ],
    'reassigned_client' => [
        'label_en' => 'Assigned notification to client',
        'label_fr' => 'Notification d assignation au client',
        'event' => 'reassigned',
        'recipientType' => 'client',
        'description_en' => 'Reference only: not currently sent to clients (client notifications are limited to new request and resolved/closed).',
        'description_fr' => 'Reference seulement : non envoye actuellement aux clients (les notifications client se limitent a nouvelle demande et resolue/fermee).',
