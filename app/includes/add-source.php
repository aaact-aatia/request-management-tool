...
if ($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if ($noerror) {
		header("location:/sources.php?lang={$lang_code}?status=failed"); 
		exit();
	}
...
$translations = [
	'en' => [
		'modal_title' => 'Add new source',
		'name_en' => 'Name of source (english):',
		'name_fr' => 'Name of source (french):',
		'required' => '(required)',
		'add_button' => 'Add'
	],
	'fr' => [
		'modal_title' => 'Ajouter une nouvelle source',
		'name_en' => 'Nom de la source (anglais):',
		'name_fr' => 'Nom de la source (français):',
		'required' => '(requis)',
		'add_button' => 'Ajouter'
	]
];
...
<section id="filter-id" class="modal-dialog modal-content overlay-def">
	...
	<div class="modal-body">
		<form method="post" action="/includes/add-source.php">
