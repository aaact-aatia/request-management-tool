		...
		<main role="main" property="mainContentOfPage" class="container">
			...
			<table class="wb-tables wb-tables-filter table table-striped table-hover" data-wb-tables='{ "ordering" : true }'>
				...
				<tr>
					...
					<td>
						<a class="wb-lbx btn btn-primary mrgn-rght-sm" href="includes/edit-users.php?id=<?php echo $row['id'];?>"><?= htmlspecialchars($langFile['users_edit_button']) ?><span class="wb-inv"> <?php $row['firstname'] ?> <?php $row['lastname'] ?></span></a> <a class="wb-lbx btn btn-primary" href="includes/delete-users.php?id=<?php echo $row['id'];?>"><?= htmlspecialchars($langFile['users_delete_button']) ?><span class="wb-inv"> <?php $row['firstname'] ?> <?php $row['lastname'] ?></span></a>
					</td>
				</tr>
			<?php } ?>
			</tbody>
