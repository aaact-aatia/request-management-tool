			...
			<table class="wb-tables table table-striped table-hover table-sm" data-wb-tables='{"paging": false, "columnDefs": [{ "type": "html-num", "targets": 0 }]}'>
				...
				while($row = mysqli_fetch_array($result)){
					...
					if ($survey==1) {
						...
						$ebody = "Bonjour,%0d%0a%0d%0aVotre demande d'accessibilité a été complété par un membre de notre équipe, serait-il possible pour vous de compléter sondage sur la satisfaction de la clientèle? Ce sondage nous aidera à mieux servir nos clients et ne prendra que 30 secondes à remplir.%0d%0a%0d%0ahttps://gcdc-ssc-ictaccess-linux-aaact-rmt-dev-asv.azurewebsites.net/css.php?lang=fr&erid=".$nrequestid."%0d%0a%0d%0a**********************************************************%0d%0a%0d%0aHello,%0d%0a%0d%0aYour accessibility request has now been completed by one of our team members, could you please fill out the following client satisfaction survey? This survey will help us serve our clients better and will only take 30 seconds to complete.%0d%0a%0d%0ahttps://gcdc-ssc-ictaccess-linux-aaact-rmt-dev-asv.azurewebsites.net/css.php?lang=en&erid=".$nrequestid."%0d%0a%0d%0aMerci / Thank you"
				?>
				<tr>
					<td><a href="viewrequest.php?lang=<?= $_SESSION['lang'] ?>&erid=<?php echo base64_encode($requestid);?>&reqid=<?php echo urlencode('a11y-' . $requesttid);?>">a11y-<?php echo $requesttid ?> <span class="glyphicon glyphicon-eye-open"></span><span class="wb-inv"><?= htmlspecialchars($langFile['css_pending_details']) ?></span></a></td>
