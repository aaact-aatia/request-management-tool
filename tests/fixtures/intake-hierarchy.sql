...
INSERT INTO `tblsubservices` (`id`, `serviceid`, `nameen`, `namefr`, `contactid`, `request_subject_type`, `status`) VALUES
(301, 202, 'Required detail', 'Précision obligatoire', 3, 'subject', 1),
(302, 202, 'Inactive detail', 'Précision inactive', NULL, NULL, 0);
